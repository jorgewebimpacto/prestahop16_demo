...
{if $errors|@count == 0}
	...
	<div class="primary_block row block" itemscope itemtype="http://schema.org/Product">
		...
		{/if}
		<!-- left infos-->  
		<div class="pb-left-column col-xs-12 col-sm-6 col-md-5 col-lg-6">
			<!-- product img-->        
		...
		<!-- end left infos-->
		<!-- pb-right-column-->
		<div class="pb-right-column col-xs-6 col-sm-6 col-md-7 col-lg-3">
														...
														<ul>
															...
															{foreach from=$group.attributes key=id_attribute item=group_attribute}
																<li onclick = "changeColor(this);">
																	<div  class="radio"><input type="radio"  name="{$groupName|escape:'html':'UTF-8'}" value="{$id_attribute}" {if ($group.default == $id_attribute)} checked="checked"{/if} />
																	</div> <span  style="display: inline-block;position: absolute;margin: 0;left: 0;top: 2;width: 29px;height: 29px;">{$group_attribute|escape:'html':'UTF-8'}</span>
																	<div  class="label_radio_btn" style="position:absolute; z-index:2;"></div>
																	</li>
															{/foreach}
														</ul>
													{/if}
